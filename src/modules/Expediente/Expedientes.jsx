...
const ExpedienteTable = () => {
    ...
    const [deleteExp, setDelete] = useState(false);

    useEffect(() => {
        // Fetch data from the API
        // fetch("http://3.23.166.218:4000/expedientes")
        fetch(baseUrl)
    ...
    }, [deleteExp]); // Empty dependency array ensures this effect runs only once

    const handleDelete = async (id) => {
        try {
            //await fetch(`http://3.23.166.218:4000/expedientes/${id}`,
            ...
            setTimeout(() => {
                ...
                // Ocultar el mensaje emergente después de un tiempo
