        ...
        <TableContainer component={Paper}>
          <Table>
            <TableHead className="tablecell">
              <TableRow>
                <TableCell align={"center"} style={{ color: "#0e9390" }}>
                  PRIORITARIO
                </TableCell>
                <TableCell align={"center"} style={{ color: "#0e9390" }}>
                  FECHA
                </TableCell>
                <TableCell style={{ color: "#0e9390" }}>
              ...
              {displayedExpedientes.map((expediente, index) => (
                <TableRow key={index}>
                  <TableCell style={{ textAlign: "center" }}>
                    <Checkbox
                      defaultChecked={expediente.prioritario}
                      disabled
                    ></Checkbox>
                  </TableCell>
                  ...
                  <TableCell>
                    <div className="actions">
                      ...
                      <Button
                        variant="text"
                        onClick={() => handleEdit(expediente.idexpediente)}
                        startIcon={<EditIcon />}
                        color="primary"
                      ></Button>
                      <Button
        ...
        >
          ...
          >
            <h2 id="simple-modal-title">
              ¿Estás seguro que quieres eliminar el expediente?
            </h2>
            <Button onClick={() => confirmDelete(expedienteId)}>
              Eliminar
            </Button>
